...
productRoutes.post('/addtocart', requireAuth, addtocart);
productRoutes.get('/getcart', requireAuth, getcart);
productRoutes.delete('/', requireAuth, deleteproduct);
productRoutes.post('/updatecart', requireAuth, updatecart);
productRoutes.post('/mergecart', requireAuth, mergecart);
